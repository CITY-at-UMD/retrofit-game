...
<html lang="en">
  ...
  <body>
        ...
        <div class="navbar">
          <div class="navbar-inner">
            ...
            <ul class="nav">
              ...
              <li class="active"><a href="eem_measure.php">EEM Measure List</a></li>
	...
	<!-- main content -->
		...
		<div id="tree-menu">
		<ol class="tree ">
		<form name="input" action="measure_list.php" method="post" onsubmit="$('#baseline-form, header, .top-nav, footer').fadeTo('slow', 0.33);
				...
				<ol>
					<li>
						...
						<ol>
							<li>
								<!-- Ventilation Setback -->
								<label for="turn-off-ventilation">Ventilation Setback</label> <input type="checkbox" id="turn-off-ventilation" name="selected[]" value="ventilationChecked" <?php if($_SESSION['measureFinished']['ventilationChecked'] == 'finished') echo 'disabled';?>/> 
								<ol>
									<li>
										<div>
											<br>
			...
			<li>
				...
				<ol>
					<li>
						<!-- Equipment -->
						<label for="equipment">Equipment</label> <input type="checkbox" id="equipment" name="selected[]" value="equipmentChecked"  <?php if($_SESSION['measureFinished']['equipmentChecked'] == 'finished') echo 'disabled';?> /> 
						<ol>					
							...
							<!-- Plug Load Control -->
							<li>
								<label for="plug-load-control">Plug Load Control</label> <input type="checkbox" id="plug-load-control" name="selected[]" value="plcChecked" <?php if($_SESSION['measureFinished']['plugLoadChecked'] == 'finished') echo 'disabled';?>/> 
								<ol>				
									<li>
										<div>
											<br>
				...
				<ol>
					...
					<li>
						...
						<ol>
							...
							<li>
								<label for="occupancy-sensors">Occupancy-Based Lighting Sensors</label> <input type="checkbox" id="occupancy-sensors" name="selected[]" value="oblsChecked" <?php if($_SESSION['measureFinished']['oblsChecked'] == 'finished') echo 'disabled';?>/> 
								<ol>
									<li>
										<div>
											<br>
							...
							<li>
								<label for="office-lighting">Office Lighting Fixture Upgrade</label> <input type="checkbox" id="office-lighting" name="selected[]" value="OfficefixturedChecked" <?php if($_SESSION['measureFinished']['OfficefixturedChecked'] == 'finished') echo 'disabled';?> /> 
								<ol>
								<li>
									</br>								
									<table border="0" cellpadding="5" style="font-size: 12px;"> 
							...
							<li>
								<label for="bathroom-lighting">Bathroom Lighting Fixture Upgrade</label> <input type="checkbox" id="bathroom-lighting" name="selected[]" value="bathroomFixturedChecked" <?php if($_SESSION['measureFinished']['bathroomFixturedChecked'] == 'finished') echo 'disabled';?> /> 
								<ol>
								<li>
									</br>								
									<table border="0" cellpadding="5" style="font-size: 12px;"> 
							...
							<li>
								<label for="emergency-lighting">Emergency Lighting Upgrade</label> <input type="checkbox" id="emergency-lighting" name="selected[]" value="emergencyLightingChecked" <?php if($_SESSION['measureFinished']['emergencyLightingChecked'] == 'finished') echo 'disabled';?> /> 
								<ol>
								<li>
									</br>								
									<table border="0" cellpadding="5" style="font-size: 12px;"> 
				...
				<ol>
					...
					<li>
						...
						<ol>
							...
							<li>
								<label for="increase-roof-insulation">Increase Roof Insulation, R-10</label> <input type="checkbox" id="increase-roof-insulation" name="selected[]" value="roofInsulationChecked" <?php if($_SESSION['measureFinished']['roofInsulationChecked'] == 'finished') echo 'disabled';?> /> 
								<ol>			
									<li>
										<div>
											<br>
					...
					<!-- Exterior Wall -->
					<li>
						<label for="exterior-wall">Exterior Wall</label> <input type="checkbox" id="exterior-wall" name="selected[]" value="exteriorWallChecked" <?php if($_SESSION['measureFinished']['exteriorWallChecked'] == 'finished') echo 'disabled';?> /> 
						<ol>
							<!-- Increase Wall Insulation, R-10 -->
							<li>
								<label for="increase-wall-insulation-1">Increase Wall Insulation, R-10</label> <input type="checkbox" id="increase-wall-insulation-1" name="selected[]" value="wallInsulation1Checked" <?php if($_SESSION['measureFinished']['wallInsulation1Checked'] == 'finished') echo 'disabled';?> /> 
								<ol>
									<li>
										<div>
											<br>
							...
							<li>
								<label for="increase-wall-insulation-2">Increase Wall Insulation, R-20</label> <input type="checkbox" id="increase-wall-insulation-2" name="selected[]" value="wallInsulation2Checked" <?php if($_SESSION['measureFinished']['wallInsulation2Checked'] == 'finished') echo 'disabled';?> /> 
								<ol>
									<li>
										<div>
					...
					<!-- Fenestration -->
					<li>
						<label for="Fenestration">Fenestration</label> <input type="checkbox" id="Fenestration" name="selected[]" value="fenestrationChecked"  <?php if($_SESSION['measureFinished']['fenestrationChecked'] == 'finished') echo 'disabled';?> /> 
						<ol>
							<!-- Window Upgrade -->
							<li>
					...
					<!-- Infiltration -->
					<li>
						<label for="infiltration">Infiltration</label> <input type="checkbox" id="infiltration" name="selected[]" value="infiltrationChecked" <?php if($_SESSION['measureFinished']['infiltrationChecked'] == 'finished') echo 'disabled';?> /> 
						<ol>
							<li>
								<!-- Door Weatherization -->
				...
				<ol>
					...
					<li>
						...
						<ol>
								...
								<ol>
									...
									<li>
										...
										<label for="heating-set-back" title="Set heating set point, setback, match to schedule">
											Heating Set Back
										</label> <input type="checkbox" id="heating-set-back" name="selected[]" value="heatingSBChecked" <?php if($_SESSION['measureFinished']['heatingSBChecked'] == 'finished') echo 'disabled';?> /> 
										<ol>
											<li>
												<div>								
													</br>
							...
							<li>
								<label for="condensingBoiler">Condesing Boiler </label> <input type="checkbox" id="condensingBoiler" name="selected[]" value="condensingBoilerChecked" <?php if($_SESSION['measureFinished']['condensingBoilerChecked'] == 'finished') echo 'disabled';?>/> 
								<ol>
									<li>
						...
						<ol>
							...
							<li>
								...
								<ol>
									<!-- Cooling Set Back -->
									<li>
										<label for="cooling-set-back">Cooling Set Back</label> <input type="checkbox" id="cooling-set-back" name="selected[]" value="coolingSBChecked" <?php if($_SESSION['measureFinished']['coolingSBChecked'] == 'finished') echo 'disabled';?> /> 
										<ol>
											<li>
												<div>
							...
							<li>
								<label for="system-efficiency">Condensing Unit Replacement</label> <input type="checkbox" id="system-efficiency"  name="selected[]" value="sysEffChecked" <?php if($_SESSION['measureFinished']['sysEffChecked'] == 'finished') echo 'disabled';?> /> 
								<ol>
									<!-- Condensing Unit Replacement -->
									<li>
										<div>
